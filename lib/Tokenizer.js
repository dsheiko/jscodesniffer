    ...
    return {
        ...
        processTokens: function() {
            ...
            esprimaSyntaxTree.tokens.forEach(function( fetch, index ){
                ...
                // Let's take for the token report location 
                // eprima provides its start location, but ,seems, 
                // it counts columns starting 
                // with 0, what it's confusing - that's why I increment it
                fetch.line = fetch.loc.start.line;
                fetch.column = fetch.loc.start.column + 1;
