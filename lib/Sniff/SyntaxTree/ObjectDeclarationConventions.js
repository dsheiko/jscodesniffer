...
/**
	...
	* @module Sniff/SyntaxTree/ObjectDeclarationConventions
...
var utils = require( "../Utils" ),
		...
		* @default
		*/
		NAME = "ObjectDeclarationConventions",
	/**
	* @constructor
	* @alias module:Sniff/SyntaxTree/ObjectDeclarationConventions
			...
			*/
			...
			run: function( rule, node ) {
				...
				if ( rule.requireOnePerLineWhenMultiline && node.type === "ObjectExpression" &&
					...
					if ( sameLineProps.length !== node.properties ) {
